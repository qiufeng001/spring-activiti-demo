			...
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="applicationApply">申请</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle">
								<i class="fa fa-bars"></i>
								<span class="hidden-xs">申请待办</span>
							</a>
							<ul class="dropdown-menu">
								<li><a class="ajax-link" href="applicationManager">运维主管审批</a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="myApplication">我发起的申请流程</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="historyApplication">我的申请历史</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
