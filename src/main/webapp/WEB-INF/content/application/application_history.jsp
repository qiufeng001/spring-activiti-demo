...
<div class="row">
    ...
    $(document).ready(function(){
	    ...
	    var grid=$("#grid-data").bootgrid({
		    ...
		    ajax:true,
		    url:"getApplicationHistory",
		    formatters: {
		    "applyer":function(column, row){
		    	return row.applicationApply.applyer;
		    },
		    "itemlist":function(column, row){
		    	return row.applicationApply.itemlist;
		    },
		    "total":function(column, row){
		    	return row.applicationApply.total;
		    },
		    "commands": function(column, row)
		    {
	    	    ...
	    	    grid.find(".command-run1").on("click", function(e)
	    	    {
	    	    	...
	    	    	$.post("hisDetail",{"ywh":ywh},function(data){
