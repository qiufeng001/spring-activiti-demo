            ...
            <div class="box ui-draggable ui-droppable" id="dept">
                ...
                <div class="box-content">
                    <form role="form" action="startleave" method="post">
                        ...
                        <div class="form-group has-feedback">
                            <label>总金额(元)</label> <input readonly="readonly" id="total" class="form-control"
                                                         name="total" placeholder="总金额">
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            <label>处理人</label> <input id="userId" class="form-control" name="userId" placeholder="处理人">
                        </div>
    ...
    $(document).ready(function () {
        ...
        var grid = $("#grid-data").bootgrid({
            ...
            grid.find(".command-run1").on("click", function (e) {
                ...
                $("#dept").show();
                $("#btn").click(function () {
                    $.post("task/applicationComplete/" + taskid, $("form").serialize(), function (a) {
                        alert("处理成功");
                        LoadAjaxContent("applicationManager");
                    });
